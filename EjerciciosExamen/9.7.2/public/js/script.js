...
function addCruz(nodo) {
    ...
    // Añadimos el icono de destacada
    ...
    if (enunciado.value.length == 0){ 
        ...
        .then( r => {
            ...
            if (r.result){
                ...
                nuevoBloque.setAttribute("data-destacada", "false"); // Por defecto no va a estar destacada una pregunta
                ...
                addCruz(nuevoBloque); // Añadimos el icono de borrado y el de destacar preguntas
